...
class TenantCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('cnpj')->size(4)->label('Cnpj.:');
        CRUD::field('nome')->size(4)->label('Nome.:');
        CRUD::field('url')->size(4)->label('Site.:');
        CRUD::field('email')->size(4)->label('Email.:');
        CRUD::field('telefone')->size(4)->label('Telefone.:');
        $this->crud->addField([
            'label' => "Logo",
            'name' => "logo",
            'type' => 'image',
